...
// Asynchronous main function to deploy the Mycollectibles contract
async function main() {
  // Get the contract factory (ABI and bytecode) using the contract name "Mycollectibles"
  const NFT = await hre.ethers.getContractFactory("MyCollectibles");
